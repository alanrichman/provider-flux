...
PROJECT_REPO ?= github.com/alanrichman/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 1.6.4
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-flux
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/fluxcd/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
